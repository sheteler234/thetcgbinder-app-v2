...
import { X, Settings, CreditCard, Mail, Search, Shield, Bell, Users, Package, TestTube } from 'lucide-react';
...
interface EmailProvider {
  id: string;
  name: string;
  type: 'gmail-dev' | 'gmail-prod' | 'smtp';
}
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        {/* Tab Content */}
        <div className="p-6">
          {/* Consistent width wrapper for all content */}
