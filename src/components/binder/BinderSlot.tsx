...
const BinderSlot: React.FC<BinderSlotProps> = ({ product }) => {
  ...
  if (!product) {
    return (
      <div className="relative w-full h-full aspect-[2.5/3.5] max-w-[200px] max-h-[280px] rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-800 flex items-center justify-center">
  ...
  return (
    <div 
      className="group relative w-full h-full aspect-[2.5/3.5] max-w-[200px] max-h-[280px] cursor-pointer rounded-lg overflow-hidden bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
    ...
    >
      ...
      <div className="relative w-full h-full bg-gradient-to-br from-blue-900 to-purple-900">
        ...
        {imageError && (
          <div className="absolute inset-0 bg-gradient-to-br from-amber-800 to-amber-900 flex flex-col items-center justify-center text-white p-2">
          ...
          <div className="text-center p-3 space-y-2">
            ...
            <div className="flex gap-2 mt-3">
              ...
              <button
                ...
                className="flex items-center gap-1 bg-green-600 hover:bg-green-700 disabled:bg-gray-500 disabled:cursor-not-allowed text-white px-3 py-1.5 rounded-md text-xs font-medium transition-colors"
              >
        ...
        <div className="absolute top-2 left-2 bg-black/80 text-white px-2 py-1 rounded-md text-xs font-bold group-hover:opacity-0 transition-opacity">
          {formatCurrency(product.price)}
        </div>
        
        {/* Rarity Badge */}
        <div className="absolute top-2 right-2 bg-purple-600/90 text-white px-2 py-1 rounded-md text-xs font-medium group-hover:opacity-0 transition-opacity">
